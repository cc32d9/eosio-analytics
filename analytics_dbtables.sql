...
CREATE INDEX EOSIO_VOTES_I03 ON EOSIO_VOTES (trx_id(8));
...
CREATE INDEX EOSIO_PROXY_VOTES_I03 ON EOSIO_PROXY_VOTES (trx_id(8));
...
CREATE INDEX EOSIO_DELEGATEBW_I03 ON EOSIO_DELEGATEBW (trx_id(8));
